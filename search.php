...
<body>
    ...
    <div class="d-flex">
        <a href="productpage.php" class="mx-auto"><button class="btn btn-lg btn-primary">Display All</button></a>
    </div>
        ...
        <div class="product-list">
            ...
            <?php
                ...
                while($user_data = mysqli_fetch_array($result)) {
                    ...
                    echo "                  <button class='btn btn-primary ms-auto'>Add to Cart</button>";            
                    echo "              </div>";            
                    echo "          </div>";            
                    echo "      </div>";            
                    echo "  </div>";            
